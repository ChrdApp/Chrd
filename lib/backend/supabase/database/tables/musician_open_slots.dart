...
class MusicianOpenSlotsTable extends SupabaseTable<MusicianOpenSlotsRow> {
  @override
  String get tableName => 'musician_open_slots';

  @override
  MusicianOpenSlotsRow createRow(Map<String, dynamic> data) =>
      MusicianOpenSlotsRow(data);
}

class MusicianOpenSlotsRow extends SupabaseDataRow {
  MusicianOpenSlotsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => MusicianOpenSlotsTable();
