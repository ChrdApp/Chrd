...
class RecurringGigsModelStruct extends BaseStruct {
  ...
  int? _sequenceCount;
  int get sequenceCount => _sequenceCount ?? 0;
  set sequenceCount(int? val) => _sequenceCount = val;

  void incrementSequenceCount(int amount) =>
      sequenceCount = sequenceCount + amount;

  bool hasSequenceCount() => _sequenceCount != null;
  ...
  static RecurringGigsModelStruct fromMap(Map<String, dynamic> data) =>
      RecurringGigsModelStruct(
        ...
        sequenceCount: castToType<int>(data['sequence_count']),
  ...
  static RecurringGigsModelStruct? maybeFromMap(dynamic data) => data is Map
      ? RecurringGigsModelStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static RecurringGigsModelStruct fromSerializableMap(
      ...
      RecurringGigsModelStruct(
        ...
        sequenceCount: deserializeParam(
          data['sequence_count'],
          ParamType.int,
          false,
        ),
  ...
  @override
  String toString() => 'RecurringGigsModelStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is RecurringGigsModelStruct &&
        slotId == other.slotId &&
...
RecurringGigsModelStruct createRecurringGigsModelStruct({
  int? slotId,
  String? startDate,
  String? startTime,
  String? endTime,
