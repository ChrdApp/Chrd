...
class LastMinuteGigModelStruct extends BaseStruct {
  LastMinuteGigModelStruct({
    int? slotId,
    String? startDate,
    String? startTime,
    String? endTime,
  ...
  static LastMinuteGigModelStruct fromMap(Map<String, dynamic> data) =>
      LastMinuteGigModelStruct(
  ...
  static LastMinuteGigModelStruct? maybeFromMap(dynamic data) => data is Map
      ? LastMinuteGigModelStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static LastMinuteGigModelStruct fromSerializableMap(
  ...
  @override
  String toString() => 'LastMinuteGigModelStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is LastMinuteGigModelStruct &&
        slotId == other.slotId &&
...
LastMinuteGigModelStruct createLastMinuteGigModelStruct({
  int? slotId,
  String? startDate,
  String? startTime,
  String? endTime,
