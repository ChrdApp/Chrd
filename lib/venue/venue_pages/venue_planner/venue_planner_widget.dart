...
import 'venue_planner_model.dart';
export 'venue_planner_model.dart';

class VenuePlannerWidget extends StatefulWidget {
  const VenuePlannerWidget({super.key});

  static String routeName = 'venue_planner';
  static String routePath = '/venuePlanner';

  @override
  State<VenuePlannerWidget> createState() => _VenuePlannerWidgetState();
}

class _VenuePlannerWidgetState extends State<VenuePlannerWidget> {
  late VenuePlannerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VenuePlannerModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final venuePlannerGetVenuePlannerSlotsResponse = snapshot.data!;
                ...
                children: [
                                    ...
                                    Builder(
                                      builder: (context) {
                                        final venuePlannerSlotDetails =
                                            venuePlannerGetVenuePlannerSlotsResponse
                                                .jsonBody
                                                .toList();
                                                      ...
                                                      itemBuilder: (context,
                                                        ...
                                                        return InkWell(
                                                          ...
                                                          child:
                                                            ...
                                                            key: Key(
                                                                'Keyw25_${slotsListIndex}_of_${slotsList.length}'),
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        context.pushNamed(OpenSlotDashboardWidget.routeName);
                      },
                      text: 'Add new gig proposal',
                      options: FFButtonOptions(
                        width: double.infinity,
                        height: 44.0,
                        padding: EdgeInsetsDirectional.fromSTEB(
