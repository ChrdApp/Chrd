...
import 'c_h_r_d_backout_gig_model.dart';
export 'c_h_r_d_backout_gig_model.dart';

class CHRDBackoutGigWidget extends StatefulWidget {
  const CHRDBackoutGigWidget({
    super.key,
...
class _CHRDBackoutGigWidgetState extends State<CHRDBackoutGigWidget> {
  late CHRDBackoutGigModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CHRDBackoutGigModel());
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Are you sure you want to back out of this gig:\n',
                ...
                child: Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: 'Enter your reason for leaving this gig.',
                      hintStyle:
                          FlutterFlowTheme.of(context).labelMedium.override(
                                font: GoogleFonts.montserrat(
                                  fontWeight: FlutterFlowTheme.of(context)
                      ...
                      child: wrapWithModel(
                        ...
                        child: CHRDLabelBtnWidget(
                          ...
                          onTab: () async {
                            ...
                            await widget.acceptActionBtn?.call(
