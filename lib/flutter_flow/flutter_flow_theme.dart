...
abstract class FlutterFlowTheme {
  ...
  late Color primaryCyan;
  late Color primaryViolet;
  late Color neutralDark800;
  late Color neutralDark500;
  late Color neutralDark900;
  late Color neutralLight300;
  late Color appBarClr;
  late Color hintTxt;
  late Color openColor;
  late Color textPrimary;
  late Color btnColor;
  late Color primaryGold;
  late Color secondaryMaroon;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryBackground = const Color(0xFF030303);
  late Color secondaryBackground = const Color(0xFF14181B);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF005455);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFFFFFFF);

  late Color primaryCyan = const Color(0xFF01CDD1);
  late Color primaryViolet = const Color(0xFF8B2BE3);
  late Color neutralDark800 = const Color(0xFF343840);
  late Color neutralDark500 = const Color(0xFF8B92A1);
  late Color neutralDark900 = const Color(0xFF25282E);
  late Color neutralLight300 = const Color(0xFFC5C8D0);
  late Color appBarClr = const Color(0xFF121212);
  late Color hintTxt = const Color(0xFF919191);
  late Color openColor = const Color(0xFFFFB140);
  late Color textPrimary = const Color(0xFFD9D9D9);
  late Color btnColor = const Color(0xFF515764);
  late Color primaryGold = const Color(0xFF6DC66C);
  late Color secondaryMaroon = const Color(0xFF92DB13);
